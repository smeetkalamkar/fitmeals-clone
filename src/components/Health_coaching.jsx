        ...
        <div className="hCoach">
                    ...
                    <div className="txtAppoint">
                        ...
                        <div className="contactTxt">
                            <div className="icon_imgC">
                                <img src="/icon_time.jpg" alt="cont01" width="50px"/>
                            </div>
                            <div className="icon_txtC">
                                <h3>Every day from 12:00 PM to 10:00 PM</h3>
                            </div>
                            <div className="icon_imgC">
                                <img src="/icon_contact.jpg" alt="cont02" width="50px"/>
                            </div>
                            <div className="icon_txtC">
                                <h3>+91 9100347489</h3>
                            </div>
            ...
            <div className="hC_works">
                <div className="waveWork">
                    <img src="wave.jpg" alt="bg000" width="100%"/>
                </div>
            ...
            <div className="hC_gplayDet">
                <img src="appStore_det.jpg" alt="GPlay_det" width="85%"/>
            </div>
